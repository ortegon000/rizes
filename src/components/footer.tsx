export default function Footer() {
    return (
        <>
            <section id="footer" className="fixed bottom-0 translate-y-[400px] h-auto md:h-[400px] w-full text-xl md:text-3xl font-black flex justify-center items-center bg-[#1d1b22] text-white p-8 md:p-0">

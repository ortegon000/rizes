...
export default function Header({ onMenuChange }: HeaderProps) {
    ...
    return (
        <>
            ...
            {/* Menú lateral */}
            <div className={`fixed h-full w-full md:w-1/2 top-0 right-0 z-[3000] transform transition-all duration-500 flex flex-col gap-8 bg-[#111] p-8 md:p-16 pr-10 md:pr-20 pt-28 md:pt-[200px] text-white ${menuOpen ? "translate-x-0" : "translate-x-full"
                }`}>
                ...
                <ul className="mt-8 flex gap-6">
                    <li>
                        <a href="https://www.facebook.com/rizesmx" target="_blank" className="block size-6 fill-white hover:fill-red-300 transition-colors">
                    ...
                    <li>
                        <a href="https://www.instagram.com/rizesmx/" target="_blank" className="block size-6 fill-white hover:fill-red-300 transition-colors">
                    ...
                    <li>
                        <a href="https://x.com/rizesmx" target="_blank" className="block size-6 fill-white hover:fill-red-300 transition-colors">
                    ...
                    <li>
                        <a href="https://www.tiktok.com/@rizesmx" target="_blank" className="block size-6 fill-white hover:fill-red-300 transition-colors">
                    ...
                    <li>
                        <a href="https://www.youtube.com/channel/UC760DOdswQmKqgybzsj3yPA" target="_blank" className="block size-6 fill-white hover:fill-red-300 transition-colors">
